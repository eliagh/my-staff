...
public class AppointmentResourceIntTest {
    ...
    public static Appointment createEntity(EntityManager em) {
        Appointment appointment = new Appointment()
            ...
            .isFlexible(DEFAULT_IS_FLEXIBLE)
            .notes(DEFAULT_NOTES)
    ...
    public void getAllAppointments() throws Exception {
        ...
        restAppointmentMockMvc.perform(get("/api/appointments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isFlexible").value(hasItem(DEFAULT_IS_FLEXIBLE.booleanValue())))
    ...
    public void getAppointment() throws Exception {
        ...
        restAppointmentMockMvc.perform(get("/api/appointments/{id}", appointment.getId()))
            ...
            .andExpect(jsonPath("$.isFlexible").value(DEFAULT_IS_FLEXIBLE.booleanValue()))
    ...
    public void updateAppointment() throws Exception {
        ...
        updatedAppointment
            ...
            .isFlexible(UPDATED_IS_FLEXIBLE)
            .notes(UPDATED_NOTES)
