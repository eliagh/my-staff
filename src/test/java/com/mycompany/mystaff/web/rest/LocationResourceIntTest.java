...
public class LocationResourceIntTest {
	...
	public static Location createEntity(EntityManager em) {
		Location location = new Location().name(DEFAULT_NAME).address1(DEFAULT_ADDRESS_1).address2(DEFAULT_ADDRESS_2)
				.address3(DEFAULT_ADDRESS_3).number(DEFAULT_NUMBER).postcode(DEFAULT_POSTCODE).city(DEFAULT_CITY)
	...
	public void updateLocation() throws Exception {
		...
		updatedLocation.name(UPDATED_NAME).address1(UPDATED_ADDRESS_1).address2(UPDATED_ADDRESS_2)
