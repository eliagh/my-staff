...
public class LocationResourceIntTest {
  ...
  public void createLocation() throws Exception {
    ...
    restLocationMockMvc
        .perform(
            post("/api/locations").contentType(TestUtil.APPLICATION_JSON_UTF8).header("Authorization", "Bearer " + JWT).content(TestUtil.convertObjectToJsonBytes(locationDTO)))
  ...
  public void updateLocation() throws Exception {
    ...
    restLocationMockMvc
        .perform(put("/api/locations").contentType(TestUtil.APPLICATION_JSON_UTF8).header("Authorization", "Bearer " + JWT).content(TestUtil.convertObjectToJsonBytes(locationDTO)))
        .andExpect(status().isOk());
  ...
  public void deleteLocation() throws Exception {
    ...
    // Get the location
    restLocationMockMvc.perform(delete("/api/locations/{id}", location.getId()).header("Authorization", "Bearer " + JWT).accept(TestUtil.APPLICATION_JSON_UTF8))
        .andExpect(status().isOk());
  ...
  public void searchLocation() throws Exception {
    ...
    // Search the location
    restLocationMockMvc.perform(get("/api/_search/locations?query=id:" + location.getId()).header("Authorization", "Bearer " + JWT)).andExpect(status().isOk())
