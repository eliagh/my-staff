...
describe('Company e2e test', () => {
    ...
    it('should load Companies', () => {
        ...
        expect(companyComponentsPage.getTitle()).toMatch(/mystaffApp.company.home.title/);
    ...
    it('should load create Company dialog', () => {
        ...
        expect(companyDialogPage.getModalTitle()).toMatch(/mystaffApp.company.home.createOrEditLabel/);
    ...
    it('should create and save Companies', () => {
        ...
        companyDialogPage.setSectorInput('sector');
        expect(companyDialogPage.getSectorInput()).toMatch('sector');
...
export class CompanyDialogPage {
    ...
    sectorInput = element(by.css('input#field_sector'));
    ...
    setSectorInput = function (sector) {
        this.sectorInput.sendKeys(sector);
    }

    getSectorInput = function () {
