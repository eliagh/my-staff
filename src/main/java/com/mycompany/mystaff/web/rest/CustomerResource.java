...
public class CustomerResource {
   ...
   * @return the ResponseEntity with status 201 (Created) and with body the new customer, or with
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the updated customer, or with
   *         status 400 (Bad Request) if the customer is not valid, or with status 500 (Internal
   *         Server Error) if the customer couldn't be updated
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the customer, or with status 404
   *         (Not Found)
   */
