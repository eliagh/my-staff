...
public class CompanyResource {
   ...
   * @return the ResponseEntity with status 201 (Created) and with body the new company, or with
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the updated company, or with
   *         status 400 (Bad Request) if the company is not valid, or with status 500 (Internal
   *         Server Error) if the company couldn't be updated
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the company, or with status 404
   *         (Not Found)
   */
