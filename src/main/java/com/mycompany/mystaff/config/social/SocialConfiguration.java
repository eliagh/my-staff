package com.mycompany.mystaff.config.social;
...
import com.mycompany.mystaff.repository.CustomSocialUsersConnectionRepository;
import com.mycompany.mystaff.repository.SocialUserConnectionRepository;
import com.mycompany.mystaff.repository.UserRepository;
import com.mycompany.mystaff.security.jwt.TokenProvider;
import com.mycompany.mystaff.security.social.CustomSignInAdapter;
 ...
 *
 * <p>
 * Creates the beans necessary to manage Connections to social services and link accounts from those
...
public class SocialConfiguration implements SocialConfigurer {
  ...
  @Bean
  public SignInAdapter signInAdapter(UserDetailsService userDetailsService, JHipsterProperties jHipsterProperties, TokenProvider tokenProvider, UserRepository userRepository) {
    return new CustomSignInAdapter(userDetailsService, jHipsterProperties, tokenProvider, userRepository);
  }
